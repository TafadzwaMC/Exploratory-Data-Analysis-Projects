<h1 align="center">Analyzing Pay Equity and Salary Structures</h1>

  <p align="center" >
   <img src="https://www.acquisition-international.com/wp-content/uploads/2020/04/Structuring-a-Fair-Salary-Scale.jpg"
       alt="Salary Structures" width="65%" 
</p>
...
<p align="left">
    ...
    A. Data Importation & Cleansing: Import data into the power BI  environment and cleanse it by identifying and rectifying errors, missing values, and inconsistencies in the data to ensure its accuracy and reliability.

    B. Exploratory Data Analysis: We will investigate if there are any gender or race-based disparities in compensation.

    C. Data Visualization: Power BI will be used to create interactive dashboards and visualizations that provide a clear view of compensation structures, disparities, and market competitiveness.

    D. Reporting & Recommendation: Based on the analysis, we will make recommendations to optimize compensation structures, ensuring fairness and competitiveness. 
</p>
